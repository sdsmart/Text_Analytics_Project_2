...
The purpose of this project was to cluster and visualize various food related data using some different
machine learning techniques.

Recreation Steps Phase 2
------------------------

To recreate phase 2 of this project. Simply clone the repository and run the project2-phase2.py script.

This should begin loading the yummly.json dataset followed by prompting the user
and performing the predictions.
...
I had no major problems completing this phase of the project and enjoyed learning about
clustering, classifying, and predicting.

Recreation Steps Phase 1
------------------------

To recreate phase 1 of this project. Simply clone the repository and run the project2-phase1.py script.

Make sure that the script is in the same folder as the data file: srep00196-s2.csv

On my machine, this program takes around one minute or so to complete.

Clustering Process / Justification
----------------------------------

The pipeline for this project is fairly straight forward:
...
First of all, I am slightly color blind and am absolutely horrible at picking colors,
so I apologize if my visualization looks bad in that department.
